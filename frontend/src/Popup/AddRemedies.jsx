                    ...
                    <div className="popup-body space-y-2 px-2 py-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 bg-gray-50 p-3 rounded-xl border">
                            ...
                            <div className="flex-1 w-full">
                                ...
                                />
                                <p className="text-[11px] text-gray-500 mt-1">Image is saved by backend path config (preferred: <code className="bg-gray-200 px-1 rounded text-emerald-900 font-mono text-[10px]">E:\Mongodb_Siddheswari\Remedies</code>)</p>
                            </div>
                        </div>
